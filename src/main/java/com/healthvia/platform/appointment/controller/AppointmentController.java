...
public class AppointmentController {
    ...
    // === VIDEO RANDEVU ENDPOİNTLERİ ===

    @PostMapping("/video")
    @PreAuthorize("hasAnyRole('ADMIN', 'DOCTOR', 'PATIENT')")
    @Operation(summary = "Video randevusu oluştur", description = "Zoom meeting ile video randevusu oluşturur")
    public ResponseEntity<ApiResponse<VideoAppointmentResponse>> createVideoAppointment(
            @Valid @RequestBody VideoAppointmentRequest request) {
    ...
    @PreAuthorize("hasAnyRole('ADMIN', 'DOCTOR', 'PATIENT')")
    @Operation(summary = "Meeting link getir", description = "Randevunun video görüşme linkini getirir")
    public ResponseEntity<ApiResponse<VideoAppointmentResponse>> getMeetingLink(
            @PathVariable String id,
            @AuthenticationPrincipal UserPrincipal currentUser) {

        log.info("Getting meeting link for appointment: {} by user: {}",
    ...
    @PatchMapping("/{id}/cancel-video")
    @PreAuthorize("hasAnyRole('ADMIN', 'DOCTOR', 'PATIENT')")
    @Operation(summary = "Video randevusu iptal et", description = "Video randevusunu ve Zoom meeting'i iptal eder")
    public ResponseEntity<ApiResponse<Appointment>> cancelVideoAppointment(
            @PathVariable String id,
            @RequestParam String cancelledBy,
            @RequestParam(required = false) String reason) {

        log.info("Cancelling video appointment: {} by: {}", id, cancelledBy);
