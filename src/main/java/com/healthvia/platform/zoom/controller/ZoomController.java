...
public class ZoomController {
    ...
    public ResponseEntity<ApiResponse<ZoomMeetingResponse>> createMeeting(
        ...
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(ApiResponse.success(response, "Zoom toplantısı başarıyla oluşturuldu"));
    }
    ...
    public ResponseEntity<ApiResponse<Void>> deleteMeeting(
        ...
        return ResponseEntity.ok(ApiResponse.success(null, "Zoom toplantısı başarıyla silindi"));
    }
    ...
    public ResponseEntity<ApiResponse<ZoomMeetingResponse>> updateMeeting(
        ...
        return ResponseEntity.ok(ApiResponse.success(response, "Zoom toplantısı başarıyla güncellendi"));
    }
